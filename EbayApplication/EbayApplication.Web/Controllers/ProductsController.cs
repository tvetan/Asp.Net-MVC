namespace EbayApplication.Web.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        // Todo when i add a new comment the event doesn't bind
        [Authorize]
        public ActionResult Comment(Question question)
        {
            var product = db.Products.GetById(question.ProductId);
            if (ModelState.IsValid)
            {
                var currentUser = db.Users.GetById(User.Identity.GetUserId());
                ...
                return PartialView("_Comment", question);
            }
        ...
        [Authorize]
        public ActionResult Answer(int questionId, string content)
        {
            ...
            var currentQuestion = db.Questions.GetById(questionId);
            currentQuestion.Answers.Add(answer);
            db.Questions.Update(currentQuestion);
            db.SaveChanges();
